...
**Note: As of now all the tool does is ping which is rather ineffective. I am currently working on putting together specifically crafted packets targetting common services on specific ports and will update the tool once I find success in this.**
