...
**Note: As of now all the tool does is ping the port which is rather ineffective. I am currently working on specifically crafted packets targetting common services for specific ports and will update the tool once I find success in this**
